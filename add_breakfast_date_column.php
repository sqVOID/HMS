<?php
/**
 * Migration script to add breakfast_date column for tracking when breakfast was added/paid
...
try {
    echo "Adding breakfast_date column...\n\n";
    
    $columnName = 'breakfast_date';
    $definition = "TEXT NULL DEFAULT NULL COMMENT 'When breakfast was added/paid (JSON array)'";
    ...
    echo "1. breakfast_date column now stores JSON arrays of dates\n";
    echo "2. Each time breakfast is added/modified, a new timestamp is appended\n";
    echo "3. Example format: [\"2026-06-04 10:15:23\", \"2026-06-05 14:30:00\"]\n";
    echo "4. This allows tracking multiple breakfast additions over time\n\n";
