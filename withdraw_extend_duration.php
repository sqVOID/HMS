...
try {
    ...
    logActivity($conn, 'update', 'EXTEND_DURATION_WITHDRAW',
        "Extension withdrawn for booking #{$bookingId} by {$_actor} — Refund: ₱" . number_format($refundAmount, 2),
        ['booking_id' => $bookingId, 'refund' => $refundAmount, 'withdrawn_by' => $_actor]
    );
    echo json_encode([
        'success' => true,
