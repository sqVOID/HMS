...
logActivity($conn, 'report', 'REPORT_EXPORT',
    "Payment Type (raw) report exported (XLS) by {$_exp_user} for {$startDate} to {$endDate}",
...
try {
    ...
    echo '<tr><td colspan="7" style="background-color: #4CAF50; color: white; font-weight: bold; font-size: 16px; text-align: center; padding: 10px;">Payment Type Report</td></tr>';
