...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        logActivity($conn, 'delete', 'DELETE', "Booking #{$booking_id} (" . ($booking['guest_name'] ?? 'Unknown Guest') . ") deleted", [
        ...
        logError($conn, 'delete', 'DELETE', "Failed to delete booking #{$booking_id}: " . $e->getMessage(), [
            'booking_id' => $booking_id,
            'error' => $e->getMessage()
        ], $booking_id);
    }
